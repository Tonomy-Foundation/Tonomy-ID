...
export default function SplashTransparencyScreen({ navigation }: SplashTransparencyScreenProps) {
    ...
    return (
        <SplashScreenContainer
            ...
            icon="transparency"
            description={`The software that runs ${settings.config.appName} is open-source and can be reviewed by anyone. It is maintained by the Pangea, a Dutch non-profit that practices radical transparency.`}
