                ...
                <View style={styles.content}>
                    ...
                    <View style={{ flexDirection: 'column', gap: 10 }}>
                        ...
                        <Text style={styles.darwerContent}>
                            ...
                            interconnected,{' '}
                            <Text style={styles.drawerInnerContent}>intelligent digital ecosystem.</Text>
                        </Text>
                        <Text style={styles.darwerContent}>
                            <Text style={styles.drawerInnerContent}>Industry, Enterprises and Governments </Text>are set
                            to adopt Web4 platforms.
                        </Text>
                    </View>
                </View>
            </ScrollView>
