        ...
        <>
            ...
            >
                <View>
                    <Text>
                        Username{' '}
                        <Text style={{ color: theme.colors.primary }}>{store.user.storage.username.username}</Text> is
            ...
            >
                <View>
                    <Text>
                        Your username is{' '}
                        <Text style={{ color: theme.colors.primary }}>{store.user.storage.username.username}</Text>
                    </Text>
                </View>
